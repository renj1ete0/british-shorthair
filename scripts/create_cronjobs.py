...
job = allcronjobs.new(command='python3 ~/british-shorthair/scripts/target_BSEssentials.py', comment='BS_Essentials')
job.hour.on(3)
job.every_reboot()
job.run()
allcronjobs.write()
...
job = allcronjobs.new(command='python3 ~/british-shorthair/scripts/target_BSArrival.py', comment='BS_Arrival')
job.minute.every(1)
allcronjobs.write()
